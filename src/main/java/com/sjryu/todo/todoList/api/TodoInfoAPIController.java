package com.sjryu.todo.todoList.api;
...
public class TodoInfoAPIController {
    ...
    public ResponseEntity<Object> getTodoList(
        HttpSession session, @PathVariable String type, @RequestParam String value,
        ...
        if(type.equals("status")){
            ...
            map.put("message", "type 은 status, content 둘 중 한가지만 가능합니다.");
    ...
    public ResponseEntity<Object> deleteTodo(HttpSession session, @RequestParam String start, @RequestParam String end){
